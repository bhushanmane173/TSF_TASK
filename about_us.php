...
<head>
    ...
    <title>About us - Royal Mint Bank</title>
...
<body style="background-color:#212529;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\Royal.png" alt=""
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/bhushan.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black; border:0.7rem groove orange;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Bhushan Mane</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Bharati Vidypeeth's College Of Engineering</b></p>
    </center>
