...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/Royal.png">
    <link rel="icon" type="image/png" sizes="32x32" href="statics/Royal.png">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/Royal.png">
    ...
    <title>Welcome to Royal Mint</title>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\Royal.png" alt="logo"
                    style="height: 80px; margin-left:25px; margin-top:10px; border-radius:50%"></a>
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br>Royal Mint</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/finance1.webp" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="statics/saveMoney.jpg" alt="" style="width:100%; position:absolute; z-index:-1">

    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(5px); box-shadow:3px 3px 15px black; border-radius:30px; padding:20px 0px 20px 0px;">
